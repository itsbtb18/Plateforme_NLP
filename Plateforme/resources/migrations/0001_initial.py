    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text="Descriptive title of the resource",
                        max_length=200,
                        verbose_name="Title",
                    ),
                ),
                ...
                (
                    "access_link",
                    models.URLField(blank=True, null=True, verbose_name="Access Link"),
                ),
                (
                    "keywords",
                    models.CharField(
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        help_text="Last time this resource was updated",
                        null=True,
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("comp_linguistics", "Computational Linguistics"),
                        ...
                        default="other",
                        help_text="Main field of the corpus",
                        max_length=50,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Digital Object Identifier (e.g., 10.1234/abcd)",
                        max_length=100,
                        verbose_name="DOI",
                    ),
                ),
                ...
                (
                    ...
                    models.OneToOneField(
                        limit_choices_to={"document_type": "article"},
                        on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "document",
                    models.OneToOneField(
                        limit_choices_to={"document_type": "memoir"},
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="memoir",
                        to="resources.document",
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "version",
                    models.CharField(
                        help_text="Tool version (e.g., 1.0.0)",
                        max_length=20,
                ...
                (
                    ...
                    models.URLField(
                        blank=True,
                        help_text="URL of the official documentation",
                        null=True,
                ...
                (
                    ...
                    models.CharField(
                        ...
                        default="ar",
                        help_text="Languages that this tool can process",
                        max_length=255,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "supervisor",
                    models.CharField(max_length=100, verbose_name="Thesis Supervisor"),
                ),
                ("defense_year", models.IntegerField(verbose_name="Defense Year")),
                (
                    "document",
                    models.OneToOneField(
                        limit_choices_to={"document_type": "thesis"},
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="thesis",
                        to="resources.document",
                    ),
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        default="other",
                        help_text="Primary field of the course",
                        max_length=50,
                        verbose_name="Field of Study",
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        help_text="Required level of study",
                        max_length=20,
                        verbose_name="Academic Level",
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        max_length=9,
                        validators=[resources.models.validate_academic_year],
                ...
                (
                    "institution",
                    models.ForeignKey(
                        help_text="University or school offering the course",
                        on_delete=django.db.models.deletion.CASCADE,
                        to="institutions.institution",
                        verbose_name="Institution",
                    ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="Responsible Teacher",
                    ),
                ),
            ],
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["field", "academic_level"],
                        name="resources_c_field_4caad8_idx",
                    )
                ],
            },
        ),
