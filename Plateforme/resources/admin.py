...
class ApprovableResourceAdmin(admin.ModelAdmin):
    ...
    translation_fieldset = (
        _("Translation Fields (Admin fills before approval)"),
        {
            ...
            "classes": ("collapse",),
            "description": _(
                "Fill in the Arabic and English translations before approving this content."
            ),
        },
    )
...
class CorpusAdmin(ApprovableResourceAdmin):
    ...
    list_display = ["title", "field", "author", "status_badge", "creation_date"]
    list_filter = ["approval_status", "field", "language", "creation_date"]
