...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.MIGRATE_HEADING('  RESOURCE CREATION DIAGNOSTIC TEST'))
        self.stdout.write(self.style.MIGRATE_HEADING('='*60))
        self.stdout.write('')
    ...
    def test_corpus_creation(self, user):
        ...
        try:
            ...
            self.stdout.write(self.style.SUCCESS(f'  ✓ Corpus created successfully (ID: {corpus.id})'))
            ...
            import traceback
            self.stdout.write(self.style.ERROR(f'  Stack trace:\n{traceback.format_exc()}'))
    ...
    def test_tool_creation(self, user):
        ...
        try:
            ...
            self.stdout.write(self.style.SUCCESS(f'  ✓ NLP Tool created successfully (ID: {tool.id})'))
            ...
            self.stdout.write(self.style.ERROR(f'  ✗ NLP Tool creation failed: {str(e)}'))
            import traceback
            self.stdout.write(self.style.ERROR(f'  Stack trace:\n{traceback.format_exc()}'))
    ...
    def test_course_creation(self, user):
        ...
        try:
            ...
            self.stdout.write(self.style.SUCCESS(f'  ✓ Course created successfully (ID: {course.id})'))
