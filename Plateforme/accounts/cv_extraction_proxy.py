...
def extract_cv_signup(request):
    ...
    if configured_host:
        ...
        # Use Docker-internal hostname — localhost/127.0.0.1 are never reachable
        # from inside the Django container
        service_bases.append("http://cv_processing:8002")
        ...
        for suffix in endpoint_suffixes:
            ...
            try:
                ...
                upstream_response = requests.post(
                    ...
                    timeout=300,  # CV extraction with docling can take 1-3 minutes
