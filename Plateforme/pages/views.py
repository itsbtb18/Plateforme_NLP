...
class HomePageView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # Safe defaults to avoid a 500 when DB connectivity is temporarily broken.
        context["events"] = []
        context["corpus_count"] = 0
        context["tools_count"] = 0
        context["projects_count"] = 0
        context["members_count"] = 0
        context["popular_posts"] = []
        context["most_viewed_resources"] = []
        ...
        try:
            ...
            most_viewed_corpus = Corpus.objects.filter(
                approval_status="approved"
            ...
            most_viewed_tools = NLPTool.objects.filter(
                approval_status="approved"
            ).order_by("-views_count")[:3]
            ...
            logger.warning("HomePageView DB fallback activated: %s", exc)
