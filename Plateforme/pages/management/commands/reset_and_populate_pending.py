...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        self.stdout.write(
            self.style.WARNING(
                "⚠️  This will DELETE all existing resources, events, projects, topics, and institutions!"
            )
        )
        ...
        self.stdout.write(
            self.style.NOTICE("You can now test the admin approval system.")
        )
    ...
    def _populate_institutions(self, admin_user):
        ...
        for inst_data in institutions_data:
            ...
            if specialties:
                inst.specialties.set(
                    random.sample(specialties, min(4, len(specialties)))
                )
            created_institutions.append(inst)

        self.stdout.write(
            self.style.SUCCESS(f"  ✓ Created {len(created_institutions)} institutions")
        )
    ...
    def _populate_documents(self, admin_user):
        ...
        self.stdout.write(
            self.style.SUCCESS(f"  ✓ Created {created_count} documents (PENDING)")
        )
    ...
    def _populate_courses(self, admin_user, institutions):
        ...
        if not institutions:
            self.stdout.write(
                self.style.WARNING("  No institutions. Skipping courses.")
            )
            return
        ...
        self.stdout.write(
            self.style.SUCCESS(f"  ✓ Created {created_count} courses (PENDING)")
        )
    ...
    def _populate_corpora(self, admin_user):
        ...
        self.stdout.write(
            self.style.SUCCESS(f"  ✓ Created {created_count} corpora (PENDING)")
        )
    ...
    def _populate_tools(self, admin_user):
        ...
        self.stdout.write(
            self.style.SUCCESS(f"  ✓ Created {created_count} NLP tools (PENDING)")
        )
    ...
    def _populate_projects(self, admin_user, institutions):
        ...
        if not institutions:
            self.stdout.write(
                self.style.WARNING("  No institutions. Skipping projects.")
            )
            return
        ...
        self.stdout.write(
            self.style.SUCCESS(f"  ✓ Created {created_count} projects (PENDING)")
        )
    ...
    def _populate_events(self, admin_user, institutions):
        ...
        self.stdout.write(
            self.style.SUCCESS(f"  ✓ Created {created_count} events (PENDING)")
        )
    ...
    def _populate_forum_topics(self, admin_user):
        ...
        self.stdout.write(
            self.style.SUCCESS(f"  ✓ Created {created_count} forum topics (PENDING)")
        )
