...
ROUTE_PERMISSION_MAP: dict[str, str] = {
    ...
    "admin_news": PERM_MODERATE_MESSAGES,
    "admin_news_approve": PERM_MODERATE_MESSAGES,
    "admin_news_delete": PERM_MODERATE_MESSAGES,
    "admin_news_view": PERM_MODERATE_MESSAGES,
