...
# Main admin views
    ...
    path('admin/news/<uuid:post_id>/approve/', views.admin_news_approve, name='admin_news_approve'),
    path('admin/news/<uuid:post_id>/delete/', views.admin_news_delete, name='admin_news_delete'),
    path('admin/news/<uuid:post_id>/view/', views.admin_news_view, name='admin_news_view'),
