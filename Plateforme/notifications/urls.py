...
urlpatterns = [
    ...
    # NEW: Go to notification (marks as read and redirects to content)
    path('go/<uuid:notification_id>/', views.go_to_notification, name='go_to_notification'),
    ...
    path('api/delete/<uuid:notification_id>/', views.api_delete_notification, name='api_delete'),
