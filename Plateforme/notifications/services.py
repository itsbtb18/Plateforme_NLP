...
from django.utils.translation import gettext_lazy as _, gettext, override as translation_override
...
class NotificationService:
    ...
    def _resolve_bilingual(title, message, title_kwargs=None, message_kwargs=None):
        ...
        try:
            with translation_override('en'):
                ...
                title_kwargs_en = NotificationService._resolve_kwargs_for_lang(title_kwargs, 'en')
                message_kwargs_en = NotificationService._resolve_kwargs_for_lang(message_kwargs, 'en')
        ...
        try:
            with translation_override('ar'):
                ...
                title_kwargs_ar = NotificationService._resolve_kwargs_for_lang(title_kwargs, 'ar')
                message_kwargs_ar = NotificationService._resolve_kwargs_for_lang(message_kwargs, 'ar')
                # Apply formatting if kwargs provided
                if title_kwargs_ar:
    ...
    def create_notification(
        ...
        """
        title_en, title_ar, message_en, message_ar = NotificationService._resolve_bilingual(
    ...
    @staticmethod
    def notify_group(users, notification_type, title, message, related_object=None, project_id=None, sender_id=None, title_kwargs=None, message_kwargs=None):
        notifications = []
        for user in users:
